  ...
  const requestLocationPermission = async () => {
    try {
      ...
      const hasPermission = await requestLocationPermissionUtil({
        ...
        message:
          "FitBridge needs access to your location to show nearby gyms and provide location-based features. Please enable location permissions in your device settings.",
      });
    ...
    try {
      ...
      const location = await refreshUserLocation({
        permissionOptions: {
          title: "Location Permission Required",
          message:
            "FitBridge needs access to your location to show nearby gyms.",
        },
        onSuccess: (loc) => {
    ...
    try {
      ...
      const location = await getUserLocation({
        permissionOptions: {
          title: "Location Permission Required",
          message:
            "FitBridge needs access to your location to show nearby gyms and provide location-based features.",
        },
      });
