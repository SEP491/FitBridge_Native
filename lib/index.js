...
// NOTE: The following modules have been cleaned up but kept for potential future use:
// - ./validation/validationUtils (all functions removed - duplicated locally)
// - ./utils/arrayUtils (all functions removed - not used)
