...
const orderService = {
    ...
    getPackageOrder: (customerPurchasedId) =>
        request("GET", `v1/orders/customer-purchased/${customerPurchasedId}`),

    getCourseOrder: (params) =>
        request("GET", "v1/orders/course", null, {}, params),
};
