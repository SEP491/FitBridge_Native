  ...
  if (isExpoGo) {
    return (
      <View style={styles.container}>
        <LinearGradient
          colors={["#ED2A46", "#C41E3A"]}
          style={styles.expoGoContainer}
        >
              ...
              <View style={styles.bookingRow}>
                ...
                <View style={styles.bookingInfo}>
                  ...
                  <Text style={styles.bookingValue}>
                    {booking.bookingName || "Training Session"}
                  </Text>
                </View>
              </View>
                ...
                <View style={styles.bookingInfo}>
                  ...
                  <Text style={styles.bookingValue}>
                    {booking.ptFreelanceStartTime && booking.ptFreelanceEndTime
                      ? `${booking.ptFreelanceStartTime.substring(
                          0,
                          5
                        )} - ${booking.ptFreelanceEndTime.substring(0, 5)}`
                      : "Not specified"}
                  </Text>
                </View>
              </View>
