...
export default function FAQScreen() {
  const questions = [
    ...
    "[Tạo tài khoản] Tại sao tôi không thể tạo tài khoản FitBridge bằng số điện thoại của mình?",
    "[Đổi PT] Làm sao để thay đổi huấn luyện viên PT sau khi đã kết nối qua AI?",
    "[Thanh toán] Làm sao để thanh toán gói FitBridge Premium?",
    "[Hủy dịch vụ] Làm sao để huỷ gói dịch vụ đã đặt trên FitBridge?",
    "[PT AI] AI của FitBridge sẽ giúc tôi như thế nào trong việc chọn những ai đáng để luyện tập?",
    "[Cập nhật thông tin] Làm sao để cập nhật thông tin như mục tiêu luyện tập trên FitBridge?",
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ paddingHorizontal: 0 }}>
        ...
        <View style={styles.questionGroup}>
          ...
          >
            <Text style={{ color: "#ED2A46", fontWeight: "500" }}>
              Xem thêm
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.supportBox}>
          <TouchableOpacity style={styles.supportItem}>
            <Ionicons
              ...
              style={{ marginRight: 6 }}
            />
            <Text style={styles.supportText}>Gọi tổng đài FitBridge</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.supportItem}>
            <Ionicons
              ...
              style={{ marginRight: 6 }}
            />
            <Text style={styles.supportText}>Nhắn tin cho CSKH FitBridge</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
