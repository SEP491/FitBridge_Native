...
export const DailyProgressChart = ({
  ...
  return (
    <StatCard
      title={t(
        "trainingResults.dailyProgressTracking",
    ...
    >
      ...
      {selectedMuscleGroup &&
        muscleReport.muscleGroupActivities.find(
                ...
                <>
                  ...
                  <View style={styles.muscleSummaryRow}>
                    ...
                    <View style={styles.muscleSummaryItem}>
                      ...
                      >
                        {muscleData.averageWeightLiftedPerSession?.toFixed(1)}{" "}
                        kg
                      </Text>
                      <Text style={styles.muscleSummaryLabel}>
                        Avg Weight/Session
