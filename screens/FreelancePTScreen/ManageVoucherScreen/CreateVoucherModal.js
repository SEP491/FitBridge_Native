  ...
  const handleCreateVoucher = async () => {
    ...
    try {
      ...
      if (response.status === '200' || response.status === '201') {
        Alert.alert(t('manageVoucher.success'), t('manageVoucher.voucherCreated'));
        setFormData({
          couponCode: '',
          maxDiscount: '',
          discountPercent: '',
      ...
      >
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalTitle}>{t('manageVoucher.createNewVoucher')}</Text>
          ...
          <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>{t('manageVoucher.couponCode')} *</Text>
              <TextInput
                style={styles.input}
            ...
            {/* Discount Percent */}
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>{t('manageVoucher.discountPercent')} (%) *</Text>
              <TextInput
                style={styles.input}
            ...
            {/* Max Discount */}
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>{t('manageVoucher.maxDiscount')} (VND) *</Text>
            ...
            {/* Quantity */}
            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>{t('manageVoucher.quantity')} *</Text>
              <TextInput
                style={styles.input}
          ...
          <View style={styles.modalFooter}>
            <TouchableOpacity 
              ...
              onPress={handleClose}
            >
              <Text style={styles.cancelButtonText}>{t('manageVoucher.cancel')}</Text>
            </TouchableOpacity>
            <TouchableOpacity 
            ...
            >
              {creating ? (
                ...
                <Text style={styles.createButtonText}>{t('manageVoucher.create')}</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
